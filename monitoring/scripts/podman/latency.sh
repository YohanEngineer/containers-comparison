...
average_time=$(echo "scale=9; ($total_time/($NUM_TESTS*1000000000)*1000)" | bc)
echo "bd :  La latence moyenne est: $average_time ms."
...
average_time=$(echo "scale=9; ($total_time/($NUM_TESTS*1000000000)*1000)" | bc)
echo "back : La latence moyenne est: $average_time ms."
...
average_time=$(echo "scale=9; ($total_time/($NUM_TESTS*1000000000)*1000)" | bc)
echo "front : La latence moyenne est: $average_time ms."
